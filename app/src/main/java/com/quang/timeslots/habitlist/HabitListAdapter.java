...
public class HabitListAdapter
    ...
    public interface OnHabitsReorderListener {
        void onHabitsReorder(List<Habit> habitList);
    }
...
//        super(context, 0, habits);
    ...
    /**
     * Get number of items in the list; Implementation of RecyclerView.Adapter
     * @return
     */
    @Override
    ...
    /**
     * Callback to create item holder; Implementation of RecyclerView.Adapter
     * @param parent
     * @param viewType
     * @return
     */
    ...
    /**
     * Callback to bind item holder with data; Implementation of RecyclerView.Adapter
     * @param holder
     * @param position
     */
    @Override
    public void onBindViewHolder(final HabitItemViewHolder holder, int position) {
        ...
        holder.detailsView.setTypeface(typeface);
        ...
        if (habit.id == habitTimer.getRunningHabitId()) { // This is the running habit
            ...
            holder.nameView.setTypeface(typeface, Typeface.BOLD);
